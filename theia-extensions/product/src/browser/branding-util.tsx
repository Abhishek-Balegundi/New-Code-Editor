...
export function renderWhatIs(windowService: WindowService): React.ReactNode {
    return <div className='gs-section'>
        ...
        <div>
            The SimplifyQA CodeEditor is a modern and AI Assisted IDE for desktop. The SimplifyQA CodeEditor is based on the <BrowserLink text="Theia platform"
...
export function renderTickets(windowService: WindowService): React.ReactNode {
    return <div className='gs-section'>
        ...
        <div >
            The features in the SimplifyQA CodeEditor are based on Theia and the included
            extensions/plugins. For bugs in SimplifyQA CodeEditor please consider opening an issue!!
        </div>
        <div>
            SimplifyQA CodeEditor only packages existing functionality into a product and installers
