...
import {
    renderDocumentation, renderExtendingCustomizing, renderSourceCode, renderSupport, renderTickets, renderWhatIs
} from './branding-util';
...
export class TheiaIDEGettingStartedWidget extends GettingStartedWidget {
    ...
    protected renderAIBanner(): React.ReactNode {
        return <div className='gs-section'>
            <div className='flex-grid'>
                <div className='col'>
                    <h3 className='gs-section-header'> 🚀 AI Support in the SimplifyQA CodeEditor is available! ✨</h3>

                    <div className='gs-action-container'>
                    SimplifyQA CodeEditor now contains AI support, which offers access to cutting-edge AI capabilities within our IDE.
                        <br />
                        Please note that the default model is added as GPT-4o Azure, also given option to add custom models ensuring that users can opt-in at their discretion.
                        For those who choose to use AI support, it is important to be aware that these features may generate continuous
